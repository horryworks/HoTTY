        ...
        <div className="settings-modal-body help-content">
          ...
          <details className="help-section">
            ...
            <div className="help-section-body">
              ...
              <p className="help-text">
                The <strong>Execution Mode chip</strong> at the bottom of the AI Chat pane controls how AI-suggested commands run — choose between Ask, Auto-execute safe, or Pause. When Auto-execute is on, each command is judged and either runs automatically or waits for a manual confirmation; Pause halts the auto-run loop without changing the mode, and the chip&apos;s controls let you resume. Configure the consecutive execution limit and the <strong>device-response idle timeout</strong> (default 10 seconds; 0 disables) in <strong>Settings &rarr; AI &rarr; Command Execution</strong>.
              </p>
