...
const VAR_DESCRIPTIONS: Record<string, string> = {
    ...
    'pane-color-1': 'Color 1 of 6 for AI Chat conversation color-coding (watched terminal tabs, conversation tabs, and header chips).',
    'pane-color-2': 'Color 2 of 6 for AI Chat conversation color-coding (watched terminal tabs, conversation tabs, and header chips).',
    'pane-color-3': 'Color 3 of 6 for AI Chat conversation color-coding (watched terminal tabs, conversation tabs, and header chips).',
    'pane-color-4': 'Color 4 of 6 for AI Chat conversation color-coding (watched terminal tabs, conversation tabs, and header chips).',
    'pane-color-5': 'Color 5 of 6 for AI Chat conversation color-coding (watched terminal tabs, conversation tabs, and header chips).',
    'pane-color-6': 'Color 6 of 6 for AI Chat conversation color-coding (watched terminal tabs, conversation tabs, and header chips).',
