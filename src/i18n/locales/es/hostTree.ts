...
export const hostTree = {
  ...
  netbox: {
    category: 'NetBox',
    syncTitle: 'Sincronizar desde NetBox',
    syncing: 'Sincronizando desde NetBox…',
    missing: 'no está en NetBox',
    missingTitle: 'Esta carpeta ya no está en NetBox. HoTTY la conserva porque puede contener hosts que hayas añadido.',
    managedTitle: 'Sincronizada desde NetBox. Su nombre y su ubicación los gestiona la sincronización.',
    renameBlocked: 'El nombre de esta carpeta lo define NetBox y no puede cambiarse aquí.',
    deleteWarning: 'Esta carpeta está sincronizada desde NetBox. La próxima sincronización la recreará vacía; los hosts que hayas puesto dentro no volverán.',
    syncFailed: 'Error al sincronizar con NetBox',
    syncDone: 'Sincronización con NetBox completada',
    placement: {
      matched: 'Coincide con {{prefix}} de NetBox',
      saveTo: 'Guardar en',
      here: 'Aquí: {{name}}',
      topLevel: 'Nivel superior',
      ambiguous: 'Más de una carpeta de NetBox cubre {{prefix}}, así que HoTTY no elige: {{folders}}',
      unmatched: 'Ninguna carpeta de NetBox cubre esta dirección.',
    },
  },
  folderDetails: {
    badge: 'NetBox · {{kind}}',
    kindRegion: 'Región',
    kindSite: 'Sitio',
    missingSince: 'No se encuentra en NetBox desde {{when}}',
    ipRanges: 'Rangos de IP',
    unreadableRanges: 'No se pudieron leer {{count}} rango(s) guardado(s)',
    contents: 'Contenido',
    counts: 'Carpetas {{folders}} · Hosts {{hosts}}',
    empty: 'Esta carpeta está vacía.',
    outOfRange: 'fuera de rango',
    outOfRangeTitle: 'Esta dirección no está dentro de ningún rango de IP de esta carpeta. Puede que el rango simplemente no esté registrado en NetBox.',
  },
  ...
  modal: {
    ...
    fixedTerminalSizeOn: 'Activado',
    fixedTerminalSizeOff: 'Desactivado',
    export: 'Exportar',
    import: 'Importar',
  },
  delete: {
