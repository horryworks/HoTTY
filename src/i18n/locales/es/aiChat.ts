...
export const aiChat = {
  ...
  pane: {
    ...
    popOut: 'Sacar',
    popOutTitle: 'Mover estas conversaciones a su propia ventana',
    popIn: 'Devolver',
    popInTitle: 'Devolver estas conversaciones a una ventana de HoTTY',
    windowMoving: 'Moviendo…',
    moveBlockedStreaming: 'No se puede mover mientras llega una respuesta',
    moveBlockedRunning: 'No se puede mover mientras se ejecuta un comando',
    moveBlockedConfirming: 'No se puede mover mientras algo espera tu respuesta',
    pinTitle: 'Mantener esta ventana encima',
    unpinTitle: 'Dejar de mantener esta ventana encima',
