...
export const settings = {
  ...
  sshKeys: {
    generateSection: 'Generar una clave nueva',
    generateButton: 'Generar clave…',
    generateHelp:
      'Las claves se guardan en tu carpeta .ssh como archivos OpenSSH normales, así que PuTTY, WinSCP y el comando ssh también pueden usarlas. HoTTY restringe cada clave nueva para que solo tú puedas leerla.',
    keysSection: 'Claves en tu carpeta .ssh',
    openFolder: 'Abrir carpeta',
    refresh: 'Actualizar',
    empty: 'Todavía no hay claves aquí.',
    loadError: 'No se pudo leer tu carpeta .ssh.',
    truncated: 'Esta carpeta tiene muchos archivos; solo se muestran los primeros {{count}}.',
    createdByHotty: 'Creada por HoTTY',
    hasPassphrase: 'Con frase de contraseña',
    noPublicFile: 'Sin archivo .pub',
    unreadable: 'No se pudo leer esta clave.',
    createdAt: 'Creada el {{date}}',
    copyPublicKey: 'Copiar clave pública',
    exportPublicKey: 'Guardar clave pública…',
    showAuthorizedKeys: 'Mostrar la línea para el servidor',
    authorizedKeysHelp:
      'Añade esta línea a ~/.ssh/authorized_keys en el servidor al que quieras acceder.',
    deleteKey: 'Eliminar',
    deleteOnlyOwn:
      'Aquí solo se pueden eliminar las claves creadas por HoTTY. Usa la carpeta para las demás.',
    deleteConfirmTitle: '¿Eliminar esta clave?',
    deleteConfirmMessage:
      'Se eliminarán {{name}} y su clave pública. Cualquier conexión guardada que la use dejará de funcionar. Esto no se puede deshacer.',
    deleteFailed: 'No se pudo eliminar la clave.',
    modalTitle: 'Generar una clave SSH',
    nameLabel: 'Nombre del archivo',
    nameHelp: 'El archivo con el que se guarda esta clave, dentro de tu carpeta .ssh.',
    algorithmLabel: 'Tipo',
    commentLabel: 'Comentario',
    commentHelp:
      'Viaja con la clave pública y aparece en el servidor. Suele ser una dirección de correo.',
    passphraseLabel: 'Frase de contraseña (opcional)',
    passphraseConfirmLabel: 'Confirmar frase de contraseña',
    passphraseHelp:
      'Protege el propio archivo de la clave, así una copia robada no sirve de nada. Se te pedirá al conectar.',
    passphraseMismatch: 'Las dos frases de contraseña no coinciden.',
    noPassphraseNote:
      'Sin frase de contraseña, cualquiera que obtenga el archivo puede usar la clave.',
    generate: 'Generar',
    generating: 'Generando…',
    generatingSlow: 'Una clave RSA tarda unos segundos. Espera, por favor.',
    generateFailed: 'No se pudo generar la clave.',
    createdTitle: 'Clave creada',
    createdHelp: 'Copia esta línea y añádela al servidor.',
    createdLaterHint: 'Puedes volver a ver esta línea en Ajustes ▸ Claves SSH.',
    useForConnection: 'Usar esta clave para esta conexión',
    algoEd25519: 'Ed25519 (recomendado)',
    ...
    algoHelpEd25519: 'Pequeña, rápida y aceptada por cualquier equipo razonablemente moderno.',
    algoHelpEcdsa: 'Úsala cuando un dispositivo no acepte Ed25519.',
    algoHelpRsa:
      'Para equipos de red antiguos. Si el dispositivo solo acepta la firma heredada ssh-rsa, actívala también en Protocolos.',
    nameErrorEmpty: 'Escribe un nombre.',
    nameErrorTooLong: 'Ese nombre es demasiado largo.',
    nameErrorInvalidCharacters: 'Usa solo letras, dígitos, punto, guion bajo y guion.',
    nameErrorStartsWithDot: 'Un nombre no puede empezar por un punto.',
    nameErrorEndsWithDot: 'Un nombre no puede terminar en un punto.',
    nameErrorIsPublicKey: 'Los nombres que terminan en .pub pertenecen a claves públicas.',
    nameErrorReservedDevice: 'Ese nombre está reservado por Windows.',
    nameErrorTaken: 'Ya existe una clave con ese nombre.',
    commentErrorTooLong: 'Ese comentario es demasiado largo.',
    commentErrorHasLineBreak: 'Un comentario no puede contener saltos de línea.',
  },
  features: {
  ...
  netbox: {
    serverSection: 'Servidor NetBox',
    baseUrl: 'URL base',
    baseUrlHelp: 'La dirección de tu NetBox, p. ej. https://netbox.example.com. HoTTY solo lee de él; nunca escribe nada.',
    baseUrlPlaceholder: 'https://netbox.example.com',
    insecureWarning: 'Esta dirección usa http://, por lo que el token de API se enviará sin cifrar.',
    token: 'Token de API',
    tokenHelp: 'Un token de API de NetBox con acceso de lectura a Regions y Sites. Se cifra con DPAPI de Windows y nunca sale de este PC.',
    tokenPlaceholder: 'Pega el token',
    tokenSaved: 'Hay un token guardado.',
    replaceToken: 'Sustituir el token',
    connect: 'Conectar',
    connecting: 'Conectando…',
    disconnect: 'Desconectar',
    disconnectHelp: 'Olvida el token. Las carpetas ya sincronizadas siguen en el árbol; simplemente dejan de actualizarse.',
    resultConnected: 'Conectado a NetBox {{version}}.',
    resultConnectedNoVersion: 'Conectado a NetBox.',
    resultRefused: 'Esa dirección es un NetBox (API {{apiVersion}}), pero rechazó el token.',
    resultRefusedNoVersion: 'Esa dirección respondió, pero rechazó el token.',
    resultNotNetbox: 'Algo respondió en esa dirección, pero no es una API de NetBox (HTTP {{status}}).',
    resultUnreachable: 'No se pudo alcanzar una API de NetBox en esa dirección.',
    siteIdSection: 'Campo del ID de sitio',
    siteIdLabel: 'Qué campo de NetBox contiene el código del sitio',
    siteIdHelp: 'Las carpetas de sitio se nombran "código nombre del sitio". Qué campo contiene el código varía según la organización: el campo facility de NetBox suele estar vacío y el código se guarda en un campo personalizado.',
    siteIdNone: '(sin código — solo el nombre del sitio)',
    siteIdOther: 'Otro — escribe el nombre del campo…',
    siteIdCustomKeyPlaceholder: 'nombre del campo personalizado',
    siteIdCustomKeyInvalid: 'Un nombre de campo personalizado solo puede contener letras, números y guiones bajos.',
    siteIdExample: 'Las carpetas se llamarán como "{{example}}".',
    customFieldsDenied: 'HoTTY no pudo leer las definiciones de campos personalizados de este NetBox: al token de API le falta extras.view_customfield. Si el código de sitio está en un campo personalizado, elige "Otro" y escribe su nombre.',
    customFieldsEmpty: 'Este NetBox no define campos personalizados que puedan contener un código de sitio.',
    refreshFields: 'Actualizar lista de campos',
    syncSection: 'Sincronización',
    syncOnStartup: 'Sincronizar al iniciar HoTTY',
    syncOnStartupHelp: 'Se ejecuta una vez al iniciar, solo en la ventana principal. Un fallo se registra aquí en lugar de mostrarse como aviso.',
    syncNow: 'Sincronizar ahora',
    syncing: 'Sincronizando…',
    notConfigured: 'Introduce arriba la dirección y el token de NetBox para habilitar la sincronización.',
    neverSynced: 'Aún sin sincronizar.',
    lastSync: 'Última sincronización: {{when}}',
    lastError: 'La última sincronización falló: {{message}}',
    summaryCounts: 'Sincronizados {{regions}} regions y {{sites}} sites.',
    summaryMissing: 'Conservadas, ya no están en NetBox: {{count}} carpetas.',
    summaryDetached: 'Movidas fuera de la carpeta NetBox por ti: {{count}}. Se les cambia el nombre, pero nunca se reordenan.',
    summaryDuplicates: 'Carpetas de NetBox duplicadas de un árbol importado: {{count}}. Ahora son carpetas normales.',
    summarySiteIdPartial: 'Sin valor de ID de sitio en {{without}} de {{sites}} sitios.',
    summarySiteIdNone: 'Ningún sitio de los {{sites}} tiene valor de ID de sitio; sus carpetas conservaron el nombre de NetBox. Prueba con otro campo.',
    placementSection: 'Colocar hosts por IP',
    placementToggle: 'Usar los rangos IP de NetBox para elegir la carpeta',
    placementHelp: 'Al añadir un host, HoTTY busca su dirección IP entre los prefijos IPAM asociados a tus regiones y sedes, y preselecciona la carpeta que coincide. Solo sugiere: puedes elegir otra carpeta antes de guardar, y una sincronización nunca mueve un host por su cuenta.',
    placementFetchNote: 'Mientras esto está desactivado, los prefijos no se descargan. Después de activarlo, pulsa "Sincronizar ahora".',
    placementScan: 'Ordenar todos los hosts por rango de IP…',
    placementScanHelp: 'Compara todos los hosts del árbol con los rangos de IP y muestra qué se movería. No se mueve nada hasta que lo confirmes, y puedes desmarcar filas antes.',
    placementScanMoved_one: 'Se movió {{count}} host.',
    placementScanMoved_other: 'Se movieron {{count}} hosts.',
    summaryPrefixes: '{{count}} prefijos leídos; {{folders}} carpetas ya pueden coincidir con un host.',
    summaryPrefixesNoFolders: 'Se leyeron {{count}} prefijos, pero ninguno quedó en una carpeta: todavía no coincidirá nada.',
    summaryPrefixesSkipped: 'Se ignoraron {{count}} prefijos asociados a algo para lo que HoTTY no tiene carpeta (una ubicación, un grupo de sedes o nada).',
    summaryPrefixesUnparsed: 'No se pudieron leer {{count}} prefijos como rango IP.',
    prefixesDenied: 'El token de API no puede leer prefijos (ipam.view_prefix). Los prefijos ya guardados se conservan y la colocación sigue funcionando con ellos.',
    prefixesTooMany: 'Este NetBox tiene más prefijos de los que HoTTY leerá. Los prefijos ya guardados se conservan; regiones y sedes se sincronizaron con normalidad.',
    prefixesDisabled: 'No se pidieron prefijos porque la colocación por IP está desactivada.',
  },
  ai: {
    // Proveedor
