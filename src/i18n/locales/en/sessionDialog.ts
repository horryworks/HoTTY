...
export const sessionDialog = {
  ...
  bookmarks: {
    ...
    nameLabel: 'Name',
    urlLabel: 'URL',
    urlPlaceholder: 'https://example.com or 192.168.1.1',
  ...
  keyPickerLabel: 'Pick a key from your .ssh folder',
  keyPickerNone: 'Pick a key…',
  keyPickerGenerate: 'Generate a new key…',
  ...
  iapPhase: {
    resolving: 'Detecting SSH account…',
    enrolling: 'Registering SSH key (first time on this PC)…',
    tunnel: 'Starting IAP tunnel…',
