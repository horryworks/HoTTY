...
export const settings = {
  ...
  sshKeys: {
    generateSection: 'Generate a new key',
    generateButton: 'Generate key…',
    generateHelp:
      'Keys are saved in your .ssh folder as ordinary OpenSSH files, so PuTTY, WinSCP and the ssh command can use them too. HoTTY locks each new key so only you can read it.',
    keysSection: 'Keys in your .ssh folder',
    openFolder: 'Open folder',
    refresh: 'Refresh',
    empty: 'No keys here yet.',
    loadError: 'Could not read your .ssh folder.',
    truncated: 'This folder has a lot of files; only the first {{count}} are shown.',
    createdByHotty: 'Created by HoTTY',
    hasPassphrase: 'Passphrase',
    noPublicFile: 'No .pub file',
    unreadable: 'Could not read this key.',
    createdAt: 'Created {{date}}',
    copyPublicKey: 'Copy public key',
    exportPublicKey: 'Save public key…',
    showAuthorizedKeys: 'Show line for the server',
    authorizedKeysHelp: 'Add this line to ~/.ssh/authorized_keys on the server you want to reach.',
    deleteKey: 'Delete',
    deleteOnlyOwn: 'Only keys HoTTY created can be deleted here. Use the folder for the rest.',
    deleteConfirmTitle: 'Delete this key?',
    deleteConfirmMessage:
      '{{name}} and its public key will be deleted. Any saved connection using it will stop working. This cannot be undone.',
    deleteFailed: 'Could not delete the key.',
    modalTitle: 'Generate an SSH key',
    nameLabel: 'File name',
    nameHelp: 'The file this key is saved as, inside your .ssh folder.',
    algorithmLabel: 'Type',
    commentLabel: 'Comment',
    commentHelp: 'Travels with the public key and shows up on the server. Often an email address.',
    passphraseLabel: 'Passphrase (optional)',
    passphraseConfirmLabel: 'Confirm passphrase',
    passphraseHelp:
      'Protects the key file itself, so a stolen copy is useless. You will be asked for it when you connect.',
    passphraseMismatch: 'The two passphrases do not match.',
    noPassphraseNote: 'Without a passphrase, anyone who gets the file can use the key.',
    generate: 'Generate',
    generating: 'Generating…',
    generatingSlow: 'An RSA key takes a few seconds. Please wait.',
    generateFailed: 'Could not generate the key.',
    createdTitle: 'Key created',
    createdHelp: 'Copy this line and add it to the server.',
    createdLaterHint: 'You can find this line again under Settings ▸ SSH Keys.',
    useForConnection: 'Use this key for this connection',
    ...
    algoHelpEd25519: 'Small, fast, and accepted by anything reasonably modern.',
    algoHelpEcdsa: 'Use when a device will not accept Ed25519.',
    algoHelpRsa:
      'For older network gear. If the device only accepts the legacy ssh-rsa signature, enable that under Protocols as well.',
    nameErrorEmpty: 'Enter a name.',
    nameErrorTooLong: 'That name is too long.',
    nameErrorInvalidCharacters: 'Use letters, digits, dot, underscore and hyphen only.',
    nameErrorStartsWithDot: 'A name cannot start with a dot.',
    nameErrorEndsWithDot: 'A name cannot end with a dot.',
    nameErrorIsPublicKey: 'Names ending in .pub belong to public keys.',
    nameErrorReservedDevice: 'That name is reserved by Windows.',
    nameErrorTaken: 'A key with that name already exists.',
    commentErrorTooLong: 'That comment is too long.',
    commentErrorHasLineBreak: 'A comment cannot contain line breaks.',
  },
  features: {
  ...
  netbox: {
    serverSection: 'NetBox server',
    baseUrl: 'Base URL',
    baseUrlHelp: 'The address of your NetBox, e.g. https://netbox.example.com. HoTTY only ever reads from it — it never writes anything back.',
    baseUrlPlaceholder: 'https://netbox.example.com',
    insecureWarning: 'This address uses http://, so the API token will be sent unencrypted.',
    token: 'API token',
    tokenHelp: 'A NetBox API token with read access to Regions and Sites. It is encrypted with Windows DPAPI and never leaves this PC.',
    ...
    disconnectHelp: 'Forgets the token. Folders already synced stay in the tree — they simply stop being updated.',
    resultConnected: 'Connected to NetBox {{version}}.',
    resultConnectedNoVersion: 'Connected to NetBox.',
    resultRefused: 'That address is a NetBox (API {{apiVersion}}), but it refused the token.',
    resultRefusedNoVersion: 'That address answered, but it refused the token.',
    resultNotNetbox: 'Something answered at that address, but it is not a NetBox API (HTTP {{status}}).',
    resultUnreachable: 'Could not reach a NetBox API at that address.',
    siteIdSection: 'Site ID field',
    siteIdLabel: 'Which NetBox field holds the site code',
    siteIdHelp: 'Site folders are named "code site name". Which field holds the code differs per organisation: the NetBox facility field is often empty, with the code kept in a custom field instead.',
    siteIdNone: '(no code — use the site name only)',
    siteIdOther: 'Other — type the field name…',
    siteIdCustomKeyPlaceholder: 'custom field name',
    siteIdCustomKeyInvalid: 'A custom field name may contain only letters, numbers and underscores.',
    siteIdExample: 'Folders will be named like "{{example}}".',
    customFieldsDenied: 'HoTTY could not read the custom-field definitions on this NetBox — the API token lacks extras.view_customfield. If your site code lives in a custom field, choose "Other" and type its name.',
    customFieldsEmpty: 'This NetBox defines no custom fields that could hold a site code.',
    refreshFields: 'Refresh field list',
    syncSection: 'Sync',
    syncOnStartup: 'Sync when HoTTY starts',
    syncOnStartupHelp: 'Runs once at launch, in the main window only. A failure is recorded here rather than shown as a popup.',
    syncNow: 'Sync now',
    syncing: 'Syncing…',
    notConfigured: 'Enter your NetBox address and token above to enable syncing.',
    neverSynced: 'Not synced yet.',
    lastSync: 'Last synced {{when}}.',
    lastError: 'Last sync failed: {{message}}',
    summaryCounts: 'Synced {{regions}} regions and {{sites}} sites.',
    summaryMissing: 'Kept, no longer in NetBox: {{count}} folders.',
    summaryDetached: 'Moved out of the NetBox folder by you: {{count}}. These are still renamed, but never re-arranged.',
    summaryDuplicates: 'Duplicated NetBox folders from an imported tree: {{count}}. They are ordinary folders now.',
    summarySiteIdPartial: 'No Site ID value on {{without}} of {{sites}} sites.',
    summarySiteIdNone: 'No Site ID value on any of the {{sites}} sites — their folders kept the plain NetBox name. Try a different field.',
    placementSection: 'Placing hosts by IP',
    ...
    summaryPrefixesUnparsed: 'Could not read {{count}} prefixes as an IP range.',
    prefixesDenied: 'The API token may not read prefixes (ipam.view_prefix). Prefixes already stored are kept, and placement keeps working from them.',
    prefixesTooMany: 'This NetBox has more prefixes than HoTTY will read. Prefixes already stored are kept; regions and sites synced normally.',
    prefixesDisabled: 'Prefixes were not requested, because placing hosts by IP is off.',
  },
  ai: {
    // Provider
