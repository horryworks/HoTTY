...
export const aiChat = {
  ...
  pane: {
    ...
    popOut: 'Move out',
    popOutTitle: 'Move these conversations into their own window',
    popIn: 'Move back',
    popInTitle: 'Move these conversations back into a HoTTY window',
    windowMoving: 'Moving…',
    moveBlockedStreaming: 'Cannot move while a reply is coming in',
    moveBlockedRunning: 'Cannot move while a command is running',
    moveBlockedConfirming: 'Cannot move while something is waiting for your answer',
    pinTitle: 'Keep this window on top',
    unpinTitle: 'Stop keeping this window on top',
