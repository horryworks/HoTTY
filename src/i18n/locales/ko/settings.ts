...
export const settings = {
  ...
  netbox: {
    ...
    placementScan: '모든 호스트를 IP 대역으로 분류…',
    placementScanHelp: '노드 트리의 모든 호스트를 IP 대역과 대조해 무엇이 어디로 이동할지 보여 줍니다. 확인하기 전에는 아무것도 이동하지 않으며, 행마다 선택을 해제할 수 있습니다.',
    placementScanMoved_one: '{{count}}대를 이동했습니다.',
    placementScanMoved_other: '{{count}}대를 이동했습니다.',
