...
export const hostTree = {
  ...
  netbox: {
    category: 'NetBox',
    syncTitle: 'NetBox에서 동기화',
    syncing: 'NetBox에서 동기화 중…',
    missing: 'NetBox에 없음',
    missingTitle: '이 폴더는 NetBox에 더 이상 없습니다. 직접 추가한 호스트가 들어 있을 수 있어 삭제하지 않고 남겨 둡니다.',
    managedTitle: 'NetBox에서 동기화된 폴더입니다. 이름과 위치는 동기화가 관리합니다.',
    renameBlocked: '이 폴더의 이름은 NetBox가 정하므로 여기서 변경할 수 없습니다.',
    deleteWarning: '이 폴더는 NetBox와 동기화됩니다. 다음 동기화에서 빈 폴더로 다시 만들어지며, 안에 넣어 둔 호스트는 복구되지 않습니다.',
    syncFailed: 'NetBox 동기화 실패',
    syncDone: 'NetBox 동기화 완료',
  },
  newConnection: '새 연결',
