...
export const aiChat = {
  ...
  pane: {
    ...
    popOut: '창으로 분리',
    popOutTitle: '이 대화를 전용 창으로 옮깁니다',
    popIn: '되돌리기',
    popInTitle: '이 대화를 HoTTY 창으로 되돌립니다',
    windowMoving: '이동 중…',
    moveBlockedStreaming: '답변을 받는 중에는 옮길 수 없습니다',
    moveBlockedRunning: '명령을 실행하는 중에는 옮길 수 없습니다',
    moveBlockedConfirming: '확인을 기다리는 항목이 있어 옮길 수 없습니다',
    pinTitle: '이 창을 항상 위에 두기',
    unpinTitle: '항상 위에 두기 해제',
