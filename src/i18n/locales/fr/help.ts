...
export const help = {
  ...
  gettingStarted: {
    ...
    gcpSshUser:
      '<0>Utilisateur SSH (à laisser vide en général) :</0> HoTTY détermine le compte Linux de connexion en interrogeant gcloud ; le champ <1>SSH user</1> de l\'onglet GCP reste donc normalement vide. Ne le renseignez que si une VM accepte un compte différent de celui détecté — la connexion échoue alors avec <2>Permission denied (publickey)</2> et l\'erreur indique le compte essayé. Notez que HoTTY lit la réponse de gcloud sans rien modifier côté Google : sur une machine dont la clé SSH n\'a jamais été enregistrée, vous devez encore exécuter <3>gcloud compute ssh &lt;instance&gt; --tunnel-through-iap</3> une fois pour l\'enregistrer.',
    gcpFiltering:
