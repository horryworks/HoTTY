...
export const settings = {
  ...
  sshKeys: {
    generateSection: 'Générer une nouvelle clé',
    generateButton: 'Générer une clé…',
    generateHelp:
      'Les clés sont enregistrées dans votre dossier .ssh sous forme de fichiers OpenSSH ordinaires, de sorte que PuTTY, WinSCP et la commande ssh peuvent aussi les utiliser. HoTTY restreint chaque nouvelle clé pour que vous seul puissiez la lire.',
    keysSection: 'Clés dans votre dossier .ssh',
    openFolder: 'Ouvrir le dossier',
    refresh: 'Actualiser',
    empty: 'Aucune clé pour le moment.',
    loadError: 'Impossible de lire votre dossier .ssh.',
    truncated: 'Ce dossier contient beaucoup de fichiers ; seuls les {{count}} premiers sont affichés.',
    createdByHotty: 'Créée par HoTTY',
    hasPassphrase: 'Avec phrase secrète',
    noPublicFile: 'Pas de fichier .pub',
    unreadable: 'Impossible de lire cette clé.',
    createdAt: 'Créée le {{date}}',
    copyPublicKey: 'Copier la clé publique',
    exportPublicKey: 'Enregistrer la clé publique…',
    showAuthorizedKeys: 'Afficher la ligne pour le serveur',
    authorizedKeysHelp:
      'Ajoutez cette ligne à ~/.ssh/authorized_keys sur le serveur que vous voulez atteindre.',
    deleteKey: 'Supprimer',
    deleteOnlyOwn:
      'Seules les clés créées par HoTTY peuvent être supprimées ici. Utilisez le dossier pour les autres.',
    deleteConfirmTitle: 'Supprimer cette clé ?',
    deleteConfirmMessage:
      '{{name}} et sa clé publique seront supprimées. Toute connexion enregistrée qui l’utilise cessera de fonctionner. Cette action est irréversible.',
    deleteFailed: 'Impossible de supprimer la clé.',
    modalTitle: 'Générer une clé SSH',
    nameLabel: 'Nom du fichier',
    nameHelp: 'Le fichier sous lequel cette clé est enregistrée, dans votre dossier .ssh.',
    algorithmLabel: 'Type',
    commentLabel: 'Commentaire',
    commentHelp:
      'Accompagne la clé publique et apparaît sur le serveur. Souvent une adresse e-mail.',
    passphraseLabel: 'Phrase secrète (facultative)',
    passphraseConfirmLabel: 'Confirmer la phrase secrète',
    passphraseHelp:
      'Protège le fichier de clé lui-même, de sorte qu’une copie volée soit inutilisable. Elle vous sera demandée à la connexion.',
    passphraseMismatch: 'Les deux phrases secrètes ne correspondent pas.',
    noPassphraseNote:
      'Sans phrase secrète, quiconque obtient le fichier peut utiliser la clé.',
    generate: 'Générer',
    generating: 'Génération…',
    generatingSlow: 'Une clé RSA prend quelques secondes. Veuillez patienter.',
    generateFailed: 'Impossible de générer la clé.',
    createdTitle: 'Clé créée',
    createdHelp: 'Copiez cette ligne et ajoutez-la au serveur.',
    createdLaterHint: 'Vous pourrez retrouver cette ligne dans Paramètres ▸ Clés SSH.',
    useForConnection: 'Utiliser cette clé pour cette connexion',
    algoEd25519: 'Ed25519 (recommandé)',
    ...
    algoHelpEd25519: 'Petite, rapide et acceptée par tout matériel raisonnablement récent.',
    algoHelpEcdsa: 'À utiliser lorsqu’un équipement n’accepte pas Ed25519.',
    algoHelpRsa:
      'Pour les équipements réseau anciens. Si l’appareil n’accepte que l’ancienne signature ssh-rsa, activez-la aussi dans Protocoles.',
    nameErrorEmpty: 'Saisissez un nom.',
    nameErrorTooLong: 'Ce nom est trop long.',
    nameErrorInvalidCharacters:
      'Utilisez uniquement des lettres, des chiffres, un point, un tiret bas ou un tiret.',
    nameErrorStartsWithDot: 'Un nom ne peut pas commencer par un point.',
    nameErrorEndsWithDot: 'Un nom ne peut pas se terminer par un point.',
    nameErrorIsPublicKey: 'Les noms se terminant par .pub appartiennent aux clés publiques.',
    nameErrorReservedDevice: 'Ce nom est réservé par Windows.',
    nameErrorTaken: 'Une clé portant ce nom existe déjà.',
    commentErrorTooLong: 'Ce commentaire est trop long.',
    commentErrorHasLineBreak: 'Un commentaire ne peut pas contenir de saut de ligne.',
  },
  features: {
  ...
  netbox: {
    serverSection: 'Serveur NetBox',
    baseUrl: 'URL de base',
    baseUrlHelp: "L'adresse de votre NetBox, par ex. https://netbox.example.com. HoTTY se contente de lire ; il n'y écrit jamais rien.",
    baseUrlPlaceholder: 'https://netbox.example.com',
    insecureWarning: "Cette adresse utilise http://, le jeton d'API sera donc envoyé en clair.",
    token: "Jeton d'API",
    tokenHelp: "Un jeton d'API NetBox ayant accès en lecture aux Regions et aux Sites. Il est chiffré avec DPAPI de Windows et ne quitte jamais ce PC.",
    tokenPlaceholder: 'Collez le jeton',
    tokenSaved: 'Un jeton est enregistré.',
    replaceToken: 'Remplacer le jeton',
    connect: 'Se connecter',
    connecting: 'Connexion…',
    disconnect: 'Déconnecter',
    disconnectHelp: "Oublie le jeton. Les dossiers déjà synchronisés restent dans l'arborescence ; ils cessent simplement d'être mis à jour.",
    resultConnected: 'Connecté à NetBox {{version}}.',
    resultConnectedNoVersion: 'Connecté à NetBox.',
    resultRefused: 'Cette adresse est bien un NetBox (API {{apiVersion}}), mais il a refusé le jeton.',
    resultRefusedNoVersion: 'Cette adresse a répondu, mais elle a refusé le jeton.',
    resultNotNetbox: "Quelque chose a répondu à cette adresse, mais ce n'est pas une API NetBox (HTTP {{status}}).",
    resultUnreachable: "Impossible d'atteindre une API NetBox à cette adresse.",
    siteIdSection: 'Champ ID de site',
    siteIdLabel: 'Quel champ NetBox contient le code du site',
    siteIdHelp: "Les dossiers de site sont nommés « code nom du site ». Le champ qui contient le code varie selon l'organisation : le champ facility de NetBox est souvent vide, le code étant plutôt dans un champ personnalisé.",
    siteIdNone: '(pas de code — uniquement le nom du site)',
    siteIdOther: 'Autre — saisissez le nom du champ…',
    siteIdCustomKeyPlaceholder: 'nom du champ personnalisé',
    siteIdCustomKeyInvalid: 'Un nom de champ personnalisé ne peut contenir que des lettres, des chiffres et des tirets bas.',
    siteIdExample: 'Les dossiers seront nommés comme « {{example}} ».',
    customFieldsDenied: "HoTTY n'a pas pu lire les définitions de champs personnalisés de ce NetBox : il manque extras.view_customfield au jeton d'API. Si votre code de site se trouve dans un champ personnalisé, choisissez « Autre » et saisissez son nom.",
    customFieldsEmpty: 'Ce NetBox ne définit aucun champ personnalisé pouvant contenir un code de site.',
    refreshFields: 'Actualiser la liste des champs',
    syncSection: 'Synchronisation',
    syncOnStartup: 'Synchroniser au démarrage de HoTTY',
    syncOnStartupHelp: "S'exécute une fois au lancement, dans la fenêtre principale uniquement. Un échec est consigné ici plutôt qu'affiché en fenêtre.",
    syncNow: 'Synchroniser maintenant',
    syncing: 'Synchronisation…',
    notConfigured: "Saisissez ci-dessus l'adresse et le jeton NetBox pour activer la synchronisation.",
    neverSynced: 'Pas encore synchronisé.',
    lastSync: 'Dernière synchronisation : {{when}}',
    lastError: 'La dernière synchronisation a échoué : {{message}}',
    summaryCounts: '{{regions}} regions et {{sites}} sites synchronisés.',
    summaryMissing: 'Conservés, absents de NetBox : {{count}} dossiers.',
    summaryDetached: 'Sortis du dossier NetBox par vos soins : {{count}}. Ils sont toujours renommés, mais jamais déplacés.',
    summaryDuplicates: "Dossiers NetBox dupliqués issus d'une arborescence importée : {{count}}. Ce sont désormais des dossiers ordinaires.",
    summarySiteIdPartial: "Aucune valeur d'ID de site sur {{without}} des {{sites}} sites.",
    summarySiteIdNone: "Aucun des {{sites}} sites n'a de valeur d'ID de site ; leurs dossiers ont gardé le nom NetBox. Essayez un autre champ.",
    placementSection: 'Classer les hôtes par IP',
    placementToggle: 'Utiliser les plages IP de NetBox pour choisir le dossier',
    placementHelp: 'À l’ajout d’un hôte, HoTTY recherche son adresse IP parmi les préfixes IPAM rattachés à vos régions et sites, et présélectionne le dossier correspondant. Il ne fait que proposer : vous pouvez choisir un autre dossier avant d’enregistrer, et une synchronisation ne déplace jamais un hôte d’elle-même.',
    placementFetchNote: 'Tant que ceci est désactivé, les préfixes ne sont pas récupérés. Après activation, appuyez sur « Synchroniser maintenant ».',
    placementScan: 'Trier tous les hôtes par plage IP…',
    placementScanHelp: "Compare chaque hôte de l'arbre aux plages IP et montre ce qui serait déplacé. Rien ne bouge avant votre confirmation, et vous pouvez décocher des lignes.",
    placementScanMoved_one: '{{count}} hôte déplacé.',
    placementScanMoved_other: '{{count}} hôtes déplacés.',
    summaryPrefixes: '{{count}} préfixes lus ; {{folders}} dossiers peuvent désormais correspondre à un hôte.',
    summaryPrefixesNoFolders: '{{count}} préfixes lus, mais aucun n’a atterri sur un dossier : rien ne correspondra encore.',
    summaryPrefixesSkipped: '{{count}} préfixes ignorés, rattachés à quelque chose dont HoTTY n’a pas de dossier (un emplacement, un groupe de sites, ou rien).',
    summaryPrefixesUnparsed: 'Impossible de lire {{count}} préfixes comme plage IP.',
    prefixesDenied: 'Le jeton d’API ne peut pas lire les préfixes (ipam.view_prefix). Les préfixes déjà enregistrés sont conservés et le classement continue de s’appuyer dessus.',
    prefixesTooMany: 'Ce NetBox contient plus de préfixes que HoTTY n’en lira. Les préfixes déjà enregistrés sont conservés ; régions et sites se sont synchronisés normalement.',
    prefixesDisabled: 'Les préfixes n’ont pas été demandés, car le classement par IP est désactivé.',
  },
  ai: {
    // Provider
