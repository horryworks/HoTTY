...
export const hostTree = {
  ...
  netbox: {
    category: 'NetBox',
    syncTitle: '從 NetBox 同步',
    syncing: '正在從 NetBox 同步…',
    missing: 'NetBox 中已不存在',
    missingTitle: '此資料夾在 NetBox 中已不存在。因為裡面可能有你自行新增的主機，HoTTY 予以保留。',
    managedTitle: '從 NetBox 同步而來。名稱與位置由同步管理。',
    renameBlocked: '此資料夾的名稱由 NetBox 決定，無法在此重新命名。',
    deleteWarning: '此資料夾與 NetBox 同步。下次同步會重新建立為空資料夾，你放入其中的主機不會復原。',
    syncFailed: 'NetBox 同步失敗',
